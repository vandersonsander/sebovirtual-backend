...
import br.com.pi.sebovirtual.repositories.PesquisaMeusPedidosRepository;

@Service
public class PesquisaMeusPedidosService {
	@Autowired
	private PesquisaMeusPedidosRepository repository;
