...
import br.com.pi.sebovirtual.services.PesquisaMinhasVendasService;

@CrossOrigin
@RestController
@RequestMapping("search-mysales")
public class PesquisaMinhasVendasController {
	@Autowired
	private PesquisaMinhasVendasService service;
